    ...
    <>
      ...
      <div className="mt-3 hidden overflow-x-auto md:block">
        <table className="min-w-full text-sm">
          <thead className="sticky top-0 z-10 bg-zinc-900 text-left text-xs uppercase tracking-wider text-zinc-400">
            <tr>
              <th
                className="px-3 py-2"
            ...
            {visible.length === 0 ? (
              ...
              visible.flatMap((m) => {
                ...
                rows.push(
                  <tr
                    key={`${m.id}-head`}
                    className="border-t-2 border-zinc-700 bg-zinc-900/50"
                  >
                    ...
                    rows.push(
                      <tr
                        ...
                        className={
                          ...
                          (isDelayFirst ? "border-t border-zinc-800/60" : "")
                        }
                      >
                        {isDelayFirst && (
                          <>
